...
const ProjectRedifinedBasedOn: React.FC = () => {
  return (
    <div className="relative">
      <div className="w-[888px] left-[93px] bottom-[-2px] opacity-[0.5] h-[240px] absolute bg-gradient-to-l from-[#e43d19] via-[#3472bc] to-[#06d6d6] blur-[10px] animate-gradient-move"></div>
